  ...
  : localStorage.setItem(
      ...
      JSON.stringify([
        ...
        },
        {
          ...
          amount: 200,
          img_url:
            "https://amyj0hn.github.io/project-images/images/bag-with-wallet.jpg",
        },
        {
          id: 3,
          ...
          amount: 250,
          img_url:
            "https://amyj0hn.github.io/project-images/images/purse-handbag.webp",
        },
        {
          id: 4,
          ...
          amount: 200,
          img_url:
            "https://amyj0hn.github.io/project-images/images/slingbag.jpg",
        },
        {
          id: 5,
          ...
          amount: 120,
          img_url:
            "https://amyj0hn.github.io/project-images/images/blackpurse.jpg",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/candy-color-sholder-bag.png",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/sholder-bag-with-purse.jpg",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/snake-skin-slingbag.webp",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/Telena-Leather-Sling-Bag.webp",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/two-toned-purse.webp",
        },

        {
          ...
          amount: "120",
          img_url:
            "https://amyj0hn.github.io/project-images/images/rhinestone-handle-bag.webp",
        },
      ])
    );
  ...
  try {
    args.forEach((product) => {
      container.innerHTML += `
          ...
          <img src="${
            product.img_url
          }" class="card-img-top store-img" alt="product">
          </div>
                <div class="card-body">
                ...
                <p class="item-name price">${product.amount}</p>
                    ...
                    <div class="row">
                      <div class="col">
                       <button class="col store-item-icon bi bi-cart" onclick='addToCart(${JSON.stringify(
                         product
                       )})'>               
                       </button> 
...
function addToCart(product) {
  try {
    let existingItem = checkoutItems.find((item) => item.id === product.id);

    if (existingItem) {
      // If item already exists, update its quantity
      alert("Product already in cart. Please see checkout.")
